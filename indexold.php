...
<body>
	...
	<div class="wrapper">
		<div class="steps-area steps-area-fixed">
			<div id="image-holder">
				<img src="asset/img/side-img3.png" alt="">
			</div>
							...
							<div class="form-content pera-content">
								<div class="step-inner-content">
									...
									<div class="language-select">
										...
										<input type="number" id="panelCapacity" name="panelPower"><h3 class="units"> W</h3> 
									</div>

									<br>
									<div class="form-inner-area">
										<h3>Panel Count</h3>
										<input type="text" id="panelCount"  class="form-control " onClick = "cal();" onmouseenter ="cal();" ontouchcancel="cal();" name="panelcount" >
									</div>
									<script>
										function cal(){
								...
								<div class="step-inner-content">
									...
									<div class="step-content-area">
										...
										<div class="comment-box">
											...
											<textarea name="mountingPara" >Mounting, DC MCB, Isolator, SPD CEB/LECO Clearing Chargers & metering Connection, Labor charges, Steel Structure (If the AC,DC cable length (Solar Panel to Inverter) is more than 30m, the cost for the increased cable length will have to be charged additional)</textarea>
										</div>
	
										
	
										<div class="budget-area" onClick="phase();">
											<br>
											<h3>Phase</h3>
										...
										<script>
											function phase(){
												if((document.getElementById("phaseSel").value)=="SinglePhase"){
													document.getElementById("elecAcc").value="BREAKER 32A";
												}else if ((document.getElementById("phaseSel").value)=="ThreePhase"){
													document.getElementById("elecAcc").value="Three Bre";
												}else{
													document.getElementById("elecAcc").value="Select a phase";
										...
										<script>
											function stru(){
												if((document.getElementById("structure").value)=="Aluminum"){
													document.getElementById("structureBOX").value="Aluminum Structure";
												}else if ((document.getElementById("structure").value)=="Steel"){
													document.getElementById("structureBOX").value="Steel Structure";
												}}
										</script>
										...
										<div class="comment-box" onClick="phase();" >
										...
										<div class="budget-area">
											<br><br><hr>
											<h3>Structure</h3>
											<select name="structure" id="structure" onClick="stru()">
										...
										<div class="comment-box" onClick="stru()">
											<label> Seperate from Comma(,)</label><br>
									...
									<div class="step-content-area">
										...
										<div class="language-select" id="usage" >
											...
											<br><br><hr>
												...
												<input type="number" id="elecBill" name="elecBill" onclick="BillCal();" ontouchcancel="BillCal();" onmouseenter="BillCal()"> LKR
												<br>
											</div>
											<script>
												function BillCal(){
